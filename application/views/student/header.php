...
<body class="fixed-nav sticky-footer bg-light" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-warning bg-light fixed-top" id="mainNav">
    <a class="navbar-brand" href="enroll">BACATS</a>
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Charts">
          <a class="nav-link" href="viewattendance">
      ...
      <ul class="navbar-nav ml-auto">
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle mr-lg-2" id="messagesDropdown" href="user_loggedin" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
